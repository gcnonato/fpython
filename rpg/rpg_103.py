...
# Decompiled from: Python 3.7.1 (default, Oct 28 2018, 08:39:03) [MSC v.1912 64 bit (AMD64)]
# Embedded file name: rpg_v_103.py
# Compiled at: 2018-04-09 20:36:57
...
while jogando:
    ...
    while True:
        ...
        print('\n Nro de inimigos = {}'.format(len(lista_inimigo)))
        print('\n\n=====' + ' STATUS DO HERÓI ' + '=====')
        if n_rodadas_b == 3:
            if n_rodadas % 10 == 0:
                if player_sp < 25:
        ...
        sleep(1.5)
        erro_skill = True
        while erro_skill and n_rodadas % 10 == 0:
            if n_rodadas > 0:
                if n_inimigos > 10:
                ...
                while 1:
                    ...
                    if n_rodadas % 10 == 0:
                        ...
                        if int(skill) == 1:
                            ...
                            if n_inimigos < 5:
                                print('\n Você NÃO pode usar o SLASH com menos de 5 inimigos')
                                erro_skill = True
                            elif player_sp < 12:
                                ...
                                opc_skill_2 = validinput('int', 'opc_skill_2', opc_skill_2, [1, 2], ' Selecionar inimigos (1) ou AUTO (2):\n')
                                if int(opc_skill_2) == 1:
                                    while cont_slash < 5:
                                        inimigo_s = str(input(' Selecione o {}� inimigo da lista acima: \n'.format(cont_slash + 1)))
                                        inimigo_s = validinput('int', 'inimigo', inimigo_s, lista_limite, f" Selecione o {cont_slash + 1}� inimigo da lista acima: \n")
            ...
            if n_rodadas_b == 3:
                ...
                if acerto >= 25:
                    ...
                    if player_vida < 0:
                        ...
                        sleep(3)
                        print(' TROVÕES IRROMPEM TODA A REGIÃO, ESTREMECENDO O ÂMPITO DO INIMIGO.\n')
                        sleep(3)
                        ...
                        sleep(3)
                        print(' E EM FRAÇÕES DE SEGUNDOS OS ALCANÇA, DESFERINDO ATAQUES DE GRANDE PODER.\n')
                        sleep(3)
                        ...
                        while n_rodadas_b < 2:
                            ...
                            while n_ataques <= tam_lista_inimigo:
                                ...
                                if escolhido[1] <= 0:
                                    str_inimigo = str(escolhido[0])
                                    tam_str_inimigo = len(str_inimigo)
                                    msg_morte = '   Você matou o inimigo {}!'.format(str_inimigo)
                                    tam_msg_morte = len(msg_morte)
                                    print(' ' + 'x' * (tam_str_inimigo + tam_msg_morte - 1))
                                    print(msg_morte)
                                    print(' ' + 'x' * (tam_str_inimigo + tam_msg_morte - 1))
...
print('\n -FIM-')
sleep(3)
# global cont_slash ## Warning: Unused global
# okay decompiling rpg_v_103__main__.pyc
