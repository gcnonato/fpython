...
cookies = {
    ...
    "URLEncapsulada": "",
    "AMCV_4435697753736FB20A490D45^%^40AdobeOrg": "-179204249^%^7CMCIDTS^%^7C17780^%^7CMCMID^%^"
                                                  "7C31354402266843196924279368692945462487^%^7"
                                                  "CMCAAMLH-1536751485^%^7C4^%^7CMCAAMB-1536776"
                                                  "792^%^7C6G1ynYcLPuiQxYZrsz_pkqfLG9yMXBpb2zX5"
                                                  "dvJdYQJzPXImdj0y^%^7CMCOPTOUT-1536179192s^%^7"
                                                  "CNONE^%^7CMCAID^%^7CNONE",
    ...
    "s_rd_visit": "1",
    "s_rd_ppvl": "UR^%^253AWEB^%^253ANLOG^%^253AHome^%^2C12^%^2C12^%^2C439^%^2C1440^%^2C439^%^2C1440^%^"
                 "2C900^%^2C1^%^2CP",
    "mbox": "PC^#283cdd1d0550457ca9e0216c014e8c89.17_28^#1599391490^|session^#9178fd5bd2fa49668bbc7080c"
            "0f93173^#1536176910",
    "_gat_UA-27731496-8": "1",
    "s_rd_ppv": "UR^%^253AWEB^%^253ANLOG^%^253AHome^%^2C9^%^2C9^%^2C439^%^2C1440^%^2C439^%^2C1440^%^2C9"
                "00^%^2C1^%^2CP",
    "s_rd_ptc": "0.82^%^5E^%^5E0.00^%^5E^%^5E0.00^%^5E^%^5E0.00^%^5E^%^5E0.12^%^5E^%^5E0.00^%^5E^%^5E14."
                "32^%^5E^%^5E0.01^%^5E^%^5E15.29",
    "s_rd_tps": "31",
    "s_rd_pvs": "30",
    "s_sq": "it-rede-geral^%^3D^%^2526c.^%^2526a.^%^2526activitymap.^%^2526page^%^253Dhttps^%^25253A^%^2"
            "5252F^%^25252Fwww.userede.com.br^%^25252F^%^2526link^%^253Dentrar^%^2526region^%^253Dform-"
            "cadastro-login^%^2526.activitymap^%^2526.a^%^2526.c^%^2526pid^%^253Dhttps^%^25253A^%^25252F"
            "^%^25252Fwww.userede.com.br^%^25252F^%^2526oid^%^253Dentrar^%^2526oidt^%^253D3^%^2526ot^%^2"
            "53DSUBMIT",
    "ADRUM": "s=1536175079518^&r=https^%^3A^%^2F^%^2Fwww.userede.com.br^%^2F^%^3F0",
    "ADRUM_BTa": "R:27^|g:b0ed740f-944f-48e9-bb08-3cdfebd107a4^|n:customer1_e5ed8bbf-1ffc-461b-8857-b6d1"
                 "43fb54e4",
    "ADRUM_BT1": "R:27^|i:8133^|e:177",
    "FedAuth": "77u/PD94bWwgdmVyc2lvbj0iMS4wIiBlbmNvZGluZz0idXRmLTgiPz48U1A+MCMuZnxtfDElM2IxMjU0MTgxOCUz"
               "Ympvc2VqYWlsdG9uQGdtYWlsLmNvbSUzYnRydWUlM2IsMCMuZnxtfDElM2IxMjU0MTgxOCUzYmpvc2VqYWlsdG9uQ"
               "GdtYWlsLmNvbSUzYnRydWUlM2IsMTMxODEwODA2ODM0MTU5ODYyLFRydWUsUFNkSlo5SVVJRXNCdHpxY045cFpFMEc"
               "xWFptT2VmakhiWXA3cWwvWGp4SEE0OUxjR1BSN2FhNi9NcUxNN2xXalFYZVorWWJaZXN0bDJuVkxGRXpMSmlNRitxS"
               "XRFRVFYdGY3QW5CSnpNaURFMlowd3FGQWR4ZEppOTY5djVzTWtsWCtvNmIva3V4NEVJZkZvQitMeTVvYXJwMm9WcVp"
               "OUXhmM1RNc0FGbHhKdzZBWmpXRzBZUHRJWjRTdkhmSzRkWWRad215dGNhOVQzOTBrL0xQQkNvWDdYN01XcjlVTlJOS"
               "zNFbHV6bVcxcEE3Sys3TmlqSXRCNisyRUJrVTcvYmVocFZXNEI0RkxUa0duZlZPRHdTcUtLem5QMlBmVVFldDgrakR"
               "6RnpDZHhSYTRxdWhsOFNqeVRlNGNydmVRb0l6N2RKZlZNR016YXR5SUcwRVJvbktBPT0saHR0cHM6Ly93d3cudXNlc"
               "mVkZS5jb20uYnIvc2l0ZXMvZmVjaGFkby9Ib21lU3BhL2luZGV4Lmh0bWw8L1NQPg==",
}
...
response = requests.get(
    "https://www.userede.com.br/sites/fechado/_vti_bin/SessaoPortal/SessaoServico.svc/consultar",
    headers=headers,
    cookies=cookies,
)
