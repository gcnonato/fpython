from carpet import csv_to_list, evaluate_job_file, get_files_in_directory, order_by_key
...
if __name__ == "__main__":
    ...
    for result in results_by_poor_level:
        print(
            "Poor level: {} - Job file: {} - Words: {}".format(
                result["poor_level"], result["job_file"], result["match_words"],
            )
        )
