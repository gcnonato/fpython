...
def download_file(html, filename):
    ...
    response = get(html, headers=headers, stream=True)
...
html = "https://www93.o0-1.com/token=iTlXm_IwcRjd0rHeXZ3Ucg/1600556091/" \
       "201.42.0.0/58/4/d8/6127949f4de21a18b1a5feb26bbf9d84-360p.mp4"
header = html.split("/")[2]
print(header)
