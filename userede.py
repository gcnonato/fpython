...
def main(driver, datas):
    ...
    wait.until(
        EC.element_to_be_clickable(
            (
                By.ID,
                "ctl00_m_g_99009a3a_150b_4bb6_8338_75cdeaf73726_ctl00_filtroControl_ddlRelatorioSelectBoxItContainer",
            )
        )
    )
    driver.find_element_by_xpath(
        '//*[@id="ctl00_m_g_99009a3a_150b_4bb6_8338_75cdeaf73726_'
        'ctl00_filtroControl_ddlRelatorioSelectBoxItArrowContainer"]'
    ).click()
    driver.find_element_by_xpath(
        '//*[@id="ctl00_m_g_99009a3a_150b_4bb6_8338_75cdeaf73726_ctl00_filtroControl_ddlRelatorioSelectBoxItOptions"]'
        '/li[1]/a/span'
    ).click()
    sleep(1)
    driver.find_element_by_xpath(
        '// *[@id="ctl00_m_g_99009a3a_150b_4bb6_8338_75cdeaf73726_ctl00_filtroControl_'
        'consultaPV_ddlTipoAssociacaoSelectBoxItArrowContainer"]'
    ).click()
    driver.find_element_by_xpath(
        '//*[@id="ctl00_m_g_99009a3a_150b_4bb6_8338_75cdeaf73726_ctl00_filtroControl_consultaPV_'
        'ddlTipoAssociacaoSelectBoxItOptions"]/li[1]/a/span'
    ).click()
    sleep(1)
    ...
    try:
        total_no_período_valor_bruto = driver.find_elements_by_xpath(
            '//*[@id="ctl00_m_g_99009a3a_150b_4bb6_8338_75cdeaf73726_ctl00_RelatorioCredito_rcTotalizadores_'
            'qiValoresConsolidados"]/div[2]/div/div[1]/div[2]'
        )[0]
    except Exception:
    ...
    total_no_periodo_valor_liquido = driver.find_elements_by_xpath(
        '//*[@id="ctl00_m_g_99009a3a_150b_4bb6_8338_75cdeaf73726_ctl00_RelatorioCredito_rcTotalizadores_'
        'qiValoresConsolidados"]/div[2]/div/div[2]/div[2]'
    )[0]
    ...
    total_por_bandeira = []
    xpath_total_bandeiras = \
        '//*[@id="ctl00_m_g_99009a3a_150b_4bb6_8338_75cdeaf73726_ctl00_RelatorioCredito_rcTotalizadores_' \
        'pnlTotaisBandeira"]/div[2]/div[1]'
        ...
        for cont in range(1, 10):
            try:
                nome_bandeira = row.find_elements_by_xpath(
                    u'//*[@id="ctl00_m_g_99009a3a_150b_4bb6_8338_75cdeaf73726_ctl00_RelatorioCredito_'
                    u'rcTotalizadores_pnlTotaisBandeira"]'
                    u'/div[2]/div[{}]/div[2]/div[1]'.format(cont)
                )[0]
                ...
                valor_bandeira = row.find_elements_by_xpath(
                    ...
                    u'[@id="ctl00_m_g_99009a3a_150b_4bb6_8338_75cdeaf73726_ctl00_RelatorioCredito_'
                    u'rcTotalizadores_pnlTotaisBandeira"]'
                    u'/div[2]/div[{}]/div[2]/div[2]'.format(cont)
                )[0]
                valor_bandeira = valor_bandeira.text
                bandeira = {nome_bandeira: valor_bandeira}
                total_por_bandeira.append(bandeira)
            except Exception:
                break
        break

    tbody = '//*[@id="ctl00_m_g_99009a3a_150b_4bb6_8338_75cdeaf73726_ctl00_RelatorioCredito_dvRelatorio"]' \
            '/table/tbody/tr'
    """
    cont = 1
