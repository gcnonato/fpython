...
class YoutubeDlScript:
    ...
    def main_function_get_id(self):
        print(
            f"Por favor, digite APENAS a ID do vídeo desejado "
            f"(Exemplo: https://www.youtube.com/watch?v=ID_DO_VÍDEO):\n{'='*80}"
        )
    ...
    def video_function_default_mp4(self):
        ...
        if self.ID == -1:
            ...
            os.system(
                "youtube-dl --format mp4 https://www.youtube.com/watch?v=" + self.ID
            )
            sleep(0.5)
