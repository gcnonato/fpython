...
html = requests.get("http://www.imparcial.com.br/classificados").content.decode("utf-8")
...
for gi in html_gallery_item:
    ...
    for item in html_itens:
        ...
        anuncio = dict(
            # procura na parte a cadeia de caracteres "<div.." pega o que tem depois,
            # procura no resultado a cadadei de caractes "<" e pega o q tem antes
            subcategoria=item.split('<div class="title"><span class="block-intitle">')[
                1
            ]
            .split("</span>")[0]
            .strip(),
            ...
            # procura na parte a cadeia de caracteres "<div.." pega o que tem depois,
            # procura no resultado a cadadei de caractes "<" e pega o q tem antes
            descricao=item.split('<div class="contents">')[1]
            .split("</div>")[0]
            .strip(),
        )
