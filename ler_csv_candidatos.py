...
resul = pd.read_csv("consulta_cand_2018_SP.csv", encoding="cp1251", sep=";", header=0)
...
candidatos_prudente = resul[resul["NM_MUNICIPIO_NASCIMENTO"] == "PRESIDENTE PRUDENTE"]
["NM_CANDIDATO"]
...
nome_dep_estadual = resul[
    (resul["DS_CARGO"] != "DEPUTADO ESTADUAL")
    & (resul["NM_URNA_CANDIDATO"] == "DR. TALMIR")
