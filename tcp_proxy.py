...
def receive_from(connection):
    ...
    # We set 1 2 second timeout; depending on your
    # target, this may need to be adjuste
...
def proxy_handler(client_socket, remote_host, remote_port, receive_first):
    ...
    if receive_first:
        ...
        # if we have data to send to our local cliente, send it
...
def server_loop(local_host, local_port, remote_host, remote_port, receive_first):
    ...
    while True:
        ...
        # start a thread to talk to the remot host
...
def main():
    ...
    if len(sys.argv[1:]) != 5:
        print("Usage: ./proxy.py [localhost] [localportt] [remotehost] [remoteport] [receive_first]")
