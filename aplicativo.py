...
from PyQt5.QtWidgets import (
    ...
    QHBoxLayout, QPushButton, QGridLayout, QSpacerItem, QSizePolicy, QLabel, QComboBox, QApplication
)
...
class Inicio(QWidget):
    def __init__(self, Form):
        ...
        spacerItem = QSpacerItem(20, 131, QSizePolicy.Minimum, QSizePolicy.Expanding)
        self.gridLayout.addItem(spacerItem, 0, 1, 1, 1)
        spacerItem1 = QSpacerItem(70, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)
        self.gridLayout.addItem(spacerItem1, 1, 0, 1, 1)
        self.label = QLabel(Form)
        self.label.setText("Inicio")
        self.gridLayout.addWidget(self.label, 1, 1, 1, 1)
        spacerItem2 = QSpacerItem(69, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)
        self.gridLayout.addItem(spacerItem2, 1, 2, 1, 1)
        spacerItem3 = QSpacerItem(20, 130, QSizePolicy.Minimum, QSizePolicy.Expanding)
...
class Configuracao(QWidget):
    def __init__(self, contentor):
        ...
        spacer = QSpacerItem(20, 87, QSizePolicy.Minimum, QSizePolicy.Expanding)
