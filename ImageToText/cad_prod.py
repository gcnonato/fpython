...
class Produtos:
    def __init__(self, master, *args, **kw):
        ...
        self.frame1 = Frame(
            master, width=1000, height=50, bg="#222125", bd=1, relief="raise"
        )
        ...
        self.e_produto = Entry(
            master, width=25, font=("arial 14 bold"), bd=1, relief="solid"
        )
        ...
        self.e_vlr_custo = Entry(
            master, width=15, font=("arial 14 bold"), bd=1, relief="solid"
        )
        ...
        self.e_estoque = Entry(
            master, width=10, font=("arial 14 bold"), bd=1, relief="solid"
        )
    ...
    def add_produto(self, *args, **kwargs):
        ...
        if (
            ...
            sql = (
                "INSERT INTO product(produto, fornecedor, vlr_custo, vlr_venda, estoque, lote, vencimento)"
                "VALUES (?,?,?,?,?,?,?) "
            )
            c.execute(
                sql,
