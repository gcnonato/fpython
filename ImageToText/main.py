...
from tkinter import Tk, Label, StringVar, Frame, LEFT, Button, Toplevel, RIGHT
...
dia_la = Label(
    janela,
    text=(
        f"{dias[hj.weekday()]}, {str(hj.day)} de {str(mes[hj.month])} de {str(hj.year)}"
    ),
...
class Aplication:
    def __init__(self, master, *args, **kwargs):
        ...
        self.menu = Frame(
            master, width=200, height=500, bg="#222125", bd=10, relief="raise"
        )
        self.menu.pack(side=LEFT)

        self.title = Label(
            master, text="Transform image to text", font=("arial", 25, "bold")
        )
        self.title.pack()
    ...
    def home_caixa(self):
        ...
        self.frame1 = Frame(self.tela1, width=400, height=600, relief="raise")
        ...
        self.frame2 = Frame(self.tela1, width=600, height=700, bd=8, relief="raise")
