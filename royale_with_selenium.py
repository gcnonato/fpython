...
class RoyaleWithSelenium:
    ...
    def main(self, url):
        driver = self.driver
        driver.get(url)
        xpath_field_input_tag = '//*[@id="zorium-root"]/div/div[2]/div/div[1]' \
                                '/div/div/div[1]/div/div/div[2]/div/div[2]/form/div[1]/div/div[1]/input'
        ...
        try:
            ...
            driver.find_element_by_xpath(
                '//*[@id="zorium-root"]/div/div[2]/div/div[1]/div/div/div[1]'
                '/div/div/div[2]/div/div[2]/form/div[2]/div/div/button'
            ).click()
